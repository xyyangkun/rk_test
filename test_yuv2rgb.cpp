...
static void scale_buffer_wh(void *src_p, int src_w, int src_h, int src_w1, int src_h1,  int src_fmt,
                            void *dst_p, int dst_w, int dst_h, int dst_fmt,
                            int rotation) {
    ...
    rga_set_rect(&dst.rect, 0, 0, 640, 360, dst_w, dst_h, dst_fmt);
    printf("%d %d %d %d\n", src_w, src_h, dst_w, dst_h);
...
int main()
{
    ...
    src2_w = 1920;
    src2_h = 1080;
    src2_type = IMAGE_TYPE_NV12;//IMAGE_TYPE_ARGB8888;//RK_FORMAT_RGBA_8888;
    ...
    {
        // src2
        const char *src2 = "1080p_nv12.yuv";
...
#if 1
    // 调用
    scale_buffer_wh(RK_MPI_MB_GetPtr(mb_src2), src2_w, src2_h, src2_w, src2_h, RK_FORMAT_YCbCr_420_SP,
